...
public class AnimationPane extends Pane {
    ...
    public void initHeroInScene(HeroRenderer heroRenderer){
        heroRenderer.goTo(this.getPrefWidth()*0.5 - heroRenderer.getFitWidth()*0.65, null);
    }

    public void initMonsterInScene(ZombieRenderer zombieRenderer, EventHandler<ActionEvent> finishedHandler)
    {
